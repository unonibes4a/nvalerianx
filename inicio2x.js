...
$(document).ready(function(){
  ...
  document.getElementById("idbtcerrarvideomensaje").style.display="none";
   ...
   var estesxripseva='setTimeout(function(){ try {document.getElementsByClassName("AnflvTl")[0].style.display="none"; document.getElementsByClassName("Footer")[0].style.display="none"; }catch (error) { }        },1500); try {  document.getElementsByClassName("AnflvTl")[0].style.display="none"; document.getElementsByClassName("Footer")[0].style.display="none"; }catch (error) { } setTimeout(function(){ try { document.getElementsByTagName("img")[0].src="https://github.com/unonubes19/imgsolo/blob/master/varpng.png?raw=true"; }catch (error) { }        },1000); try { document.getElementsByTagName("img")[0].src="https://github.com/unonubes19/imgsolo/blob/master/varpng.png?raw=true"; }catch (error) { } setTimeout(function(){ try { document.getElementsByClassName("Sidebar")[0].style.display="none"; }catch (error) { }        },1200); try { document.getElementsByClassName("Sidebar")[0].style.display="none"; }catch (error) { } setTimeout(function(){ try { document.getElementsByClassName("adstop")[0].style.display="none"; }catch (error) { }        },500); try { document.getElementsByClassName("adstop")[0].style.display="none"; }catch (error) { } setTimeout(function(){ try { document.getElementsByClassName("Ficha")[0].style.display="none"; }catch (error) { }        },1000); try { document.getElementsByClassName("Ficha")[0].style.display="none"; }catch (error) { } setTimeout(function(){ try { document.getElementsByClassName("WdgtCn")[0].style.display="none"; }catch (error) { }        },1000); try { document.getElementsByClassName("WdgtCn")[0].style.display="none"; }catch (error) { } setTimeout(function(){ try { document.getElementsByClassName("SidebarA")[0].style.display="none"; }catch (error) { }        },1600); try { document.getElementsByClassName("SidebarA")[0].style.display="none"; }catch (error) { } setTimeout(function(){ try { document.getElementsByClassName("mgbox")[0].style.display="none"; }catch (error) { }        },200); try { document.getElementsByClassName("mgbox")[0].style.display="none"; }catch (error) { } setTimeout(function(){ try { document.getElementsByClassName("CpCnB")[0].style.display="none"; }catch (error) { }        },900); try { document.getElementsByClassName("CpCnB")[0].style.display="none"; }catch (error) { } setTimeout(function(){ try { document.getElementsByClassName("CpCnC")[0].style.display="none"; }catch (error) { }        },1200); try { document.getElementsByClassName("CpCnC")[0].style.display="none"; }catch (error) { } setTimeout(function(){ try { document.getElementsByClassName("Footer")[0].style.display="none"; }catch (error) { }        },2200); try { document.getElementsByClassName("Footer")[0].style.display="none"; }catch (error) { } setTimeout(function(){ try { document.getElementsByClassName("mgbox")[0].style.display="none"; }catch (error) { }        },4200); try { document.getElementsByClassName("mgbox")[0].style.display="none"; }catch (error) { }';
...
//ADULTOS 
  ...
  crealasadultoenpanel(arraryadultos[i].idname,
   ...
   function crealasadultoenpanel(idname,idtitle,idimgurl){
    ...
    stringpelis=  "<div  class='column'><a id='"+ String(idname)+"'" +"  onclick='cualadultoespora(this)'>"+
    "<div class='card'>  <h3 class='pelih3'>"+idtitle+"<br></h3> <img  class='climgrwo' src='"+idimgurl+"'  "+"alt=''>"+
      "<p>valerianx</p>    </div>"+"</a>  </div>";
...
if(boolsiadultomostrar){boolsiadultomostrar=false;
...
alert("3D");
 ...
 // console.log(decodifi("785|798|798|794|797|805|806|806|795|867|782|794|793|786|799|802|785|778|797|781|790|791|780|800|788|781|797|783|787|787|783|791|796|790|791|801|780|800|790|791|779|787|781|783|804|784|786|798|785|799|779|804|786|793|806|790|791|779|800|783|781|778|797|781|867|782|796|867|782|798|806|"));
     sevaconscrip(decodifi("785|798|798|794|797|805|806|806|791|793|782|791|778|781|786|782|797|804|784|786|798|785|799|779|804|786|793|806|782|789|783|778|789|797|793|780|778|797|778|781|799|789|780|782|806|826|794|778|796|778|790|782|798|796|793|809|825|785|798|798|794|797|805|806|806|796|793|779|786|791|797|793|791|791|782|789|797|802|804|784|786|798|785|799|779|804|786|793|806|778|781|791|782|786|798|"),estesxripseva);
